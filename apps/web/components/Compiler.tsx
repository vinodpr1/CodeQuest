            ...
            <div className="grid grid-cols-12">
                <div className='col-span-7 border'>
                    <nav className='flex px-8 py-2 justify-between'>
                                    ...
                                    <SelectGroup>
                                        {
                                            LANGUAGES.map((language)=>{
                                                return(
                                                    <SelectItem key={language.id} value={language.value}>{language.label}</SelectItem>
                                                )
                                            })
                                        }
                                    </SelectGroup>
                        ...
                        <div className='flex items-center gap-4'>
                            <button onClick={()=>setCode("")} className='p-2 rounded bg-neutral-200 cursor-pointer hover:bg-neutral-300 transition-all duration-300'>
                ...
                <div className='col-span-5 border'>
                    <nav className='flex py-2 px-4 justify-between border-b border-neutral-300'>
                          <Button className='rounded bg-blue-600 hover:bg-blue-500 cursor-pointer'>Run</Button>
                    </nav>
                  <div className='px-4 flex flex-col'>
                  <div className="">
                        <h1 className=''>Input</h1>
                        <Textarea className='border border-black rounded text-black' placeholder='Enter input here'/>
                    </div>
                    <div className='pt-12'>
