          ...
          <div className="prose max-w-none">
            <ReactMarkdown
              components={{
                ...
                h3: ({ children }) => <h3 className="text-xl font-semibold text-gray-800 mb-2">{children}</h3>,
                h4: ({ children }) => <h4 className="text-lg font-semibold text-gray-800 mb-2">{children}</h4>,

                p: ({ children }) => <p className="text-gray-700 leading-relaxed mb-6">{children}</p>,
                
                code: ({ children }) => (
                  <pre className="bg-gray-200 p-3 rounded font-mono text-sm mb-4">{children}</pre>
                ),
